...
eval_csv = pd.read_csv("/data/user/ViT/Germany/data_IJGI18/datasets/full/240pkl/eval_paths.csv",header=None)
rootdir = '/data/user/ViT/Germany/'
...
data.to_csv( "/data/user/ViT/D3/test/germany_train_classes.csv", index=False)
